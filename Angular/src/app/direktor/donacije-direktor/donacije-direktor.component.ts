...
@Component({
  selector: 'app-donacije-direktor',
  templateUrl: './donacije-direktor.component.html',
  styleUrl: './donacije-direktor.component.css'
})
export class DonacijeDirektorComponent implements OnInit{
  ...
  async ngOnInit() {
    ...
    if (this.isLoggedIn && this.userRole === 'director') {
        this.loadDonations();
    }
  }
