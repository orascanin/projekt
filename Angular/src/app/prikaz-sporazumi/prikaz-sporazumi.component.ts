...
@Component({
  selector: 'app-prikaz-sporazumi',
  templateUrl: './prikaz-sporazumi.component.html',
  styleUrl: './prikaz-sporazumi.component.css'
})
export class PrikazSporazumiComponent implements OnInit{
  ...
  loadProcurements(): void {
    this.http.get<any[]>('http://localhost:5000/guest/guest_get_agreements').subscribe(
      response => {
