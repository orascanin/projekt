...
@Component({
  selector: 'app-prikaz-nabavke',
  templateUrl: './prikaz-nabavke.component.html',
  styleUrl: './prikaz-nabavke.component.css'
})
export class PrikazNabavkeComponent implements OnInit{
